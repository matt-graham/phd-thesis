...
\usepackage{tikz}
\usetikzlibrary{bayesnet,arrows,calc,positioning}
...
\tikzstyle{op} = [diamond, fill=white, draw=black, minimum size=8pt, inner sep=1pt, node distance=0.4]
% \det [options] {name} {caption} {inputs} {outputs}
\newcommand{\op}[5][]{ %
