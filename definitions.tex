...
\newcommand{\jacobianproddet}[1]{D_{#1}}
\newcommand{\jacobproddet}[2]{\jacobianproddet{#1}\lpa #2 \rpa}
...
\newcommand{\upden}[1]{\tilde{\probdens}_{#1}}  
\newcommand{\esttgtdens}{\varepsilon}
...
\newcommand{\flowmap}{\boldsymbol{\uppsi}}
\newcommand{\cflowmap}{\boldsymbol{\gamma}}
