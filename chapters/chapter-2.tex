...
\begin{subfigure}[b]{.46\linewidth}
\centering
  \input{data/axis-aligned-slice-sampler-bivariate-normal.tikz}
  \vspace{-6mm}
...
\begin{subfigure}[b]{.46\linewidth}
\centering
  \input{data/random-direction-slice-sampler-bivariate-normal.tikz}
  \vspace{-6mm}
