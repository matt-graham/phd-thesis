...
\subsection{Normal latent variable model}\label{subsec:pm-normal-latent-model-exp}
...
\begin{equation}
  ...
  \nrm{\vct{x} \gvn \frac{1}{M + \sigma^2 + \epsilon^2} \sum_{m=1}^M \vct{y}^{(m)}, \frac{\sigma^2+\epsilon^2}{N + \sigma^2 + \epsilon^2} \mathbf{I}}.
\end{equation}
...
\subsection{Gaussian process classifier model}\label{subsec:pm-gaussian-process-classifier-exp}
